    ...
    <div className="flex flex-col gap-6">
      <Card className="relative py-4">
        ...
        <CardHeader>
          ...
          <CardDescription>
            Система прямого (пословного) перевода английский → французский для научных статей по
            медицине и критики произведений изобразительного искусства (вариант 11): подсчёт слов,
            частотный словарь с грамматической информацией и переводом, дерево синтаксического
            разбора предложения и утилита пополнения словаря.
          </CardDescription>
        </CardHeader>
      </Card>
